...
class UserOptions:
    ...
    def get_option(self):
        ...
        explore1 = tk.Label(window, text="Explore", font=("Helvetica", 9), background="#faedd3", foreground="blue", cursor="hand2")
        explore1.place(x=400, y=652)
        ...
        explore2 = tk.Label(window, text="Explore", font=("Helvetica", 9), background="#faedd3", foreground="blue", cursor="hand2")
        explore2.place(x=400, y=685)
        
        explore1.bind("<Button-2", PlaylistRecommendation())
        explore2.bind("<Button-3", UserSpotifyDetails())
        
    # def onClickExplore(self):
            
    # # This function will be called when the label is clicked
