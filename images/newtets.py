...
class MainApp(MDApp):
    def build(self):
        ...
        # FloatLayout container for overlapping labels
        glitch_container = FloatLayout(
            size_hint=(1, None),
            height=140
        )
        ...
        glitch_container.add_widget(self.glitchlayer)
        glitch_container.add_widget(self.main_label)

        # Add the container to the scroll layout
        scroll_layout.add_widget(glitch_container)

        # Add any other widgets as needed below
        self.text2 = Label(
